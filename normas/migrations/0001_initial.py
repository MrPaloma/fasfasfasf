# Generated by Django 3.2 on 2022-04-28 15:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_publicacion', models.DateField(blank=True, null=True, verbose_name='Publicación')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text='Titulo de Consulta', max_length=700, verbose_name='Titulo de Consulta')),
                ...
                ('tipo_norma', models.ManyToManyField(blank=True, related_name='tipos_norma', to='normas.Tipo_Normas', verbose_name='Tipo de norma')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Fecha de creación')),
                ('updated', models.DateTimeField(auto_now=True, null=True, verbose_name='Fecha de actualización')),
                ('cursos', models.ManyToManyField(blank=True, related_name='keywords', to='cursos.Curso', verbose_name='Curso')),
